...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(jsr250Enabled = true, prePostEnabled = true) // Use jsr250Enabled annotation to use @RolesAllowed; Use prePostEnabled annotation to use @PreAuthorize
