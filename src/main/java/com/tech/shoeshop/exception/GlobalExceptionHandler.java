...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> HandlerInsufficientStockException(BusinessException ex){
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message(ex.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ErrorResponse> handleOptimisticLock(
        ...
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.CONFLICT.value())
                .message("Product stock was updated by another transaction. Please retry.")
                .timestamp(LocalDateTime.now())
                .build();
    ...
    public ResponseEntity<ErrorResponse> HandlerDuplicateProductException(BusinessException ex){
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message(ex.getMessage())
                .timestamp(LocalDateTime.now())
